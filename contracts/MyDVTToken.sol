...
/// @title erc 20 training project 
/// @author kaoutar sougrati

contract MyDVTToken is ERC20, Ownable {
    ...
    address public bountyWallet=0x78731D3Ca6b7E34aC0F824c42a7cC18A495cabaB;

    bytes32 public merkleRoot = 0xefba05821be36bf49febe3ec3641d18babe9d575f4daecf9ece544acdce2e014;

    uint beginDate = 1661986800; //begin date in seconds 01/09/2022

    uint _supply = _totalSupply * (10 ** decimals() );

    constructor() ERC20("DevTkn", "DVT") { 
    ...
    function publicSale(uint amount) payable external {
        ...
        require(amount <= ERC20(address(this)).balanceOf(address(this)), "Not enough tokens in the reserve");
